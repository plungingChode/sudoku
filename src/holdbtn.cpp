...
HoldButton::HoldButton(vec2 start, void (*press_action)(), void (*release_action)(), string text, int width, string font, int font_size)
    : Button(start, release_action, text, width, font, font_size), press_action(press_action)
{
}

HoldButton::HoldButton(vec2 start, void (*toggle_action)(), string text, int width, string font, int font_size)
